...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.ec608a6bd4a868556b2c.module.css" />
  ...
  <title>UHD/compare_wpost_wopost.py at main · PINTO0309/UHD</title>
  ...
  <meta name="fetch-nonce" content="v2:ee54b215-47a7-d098-4720-955e7a89b28b">

    
  <meta name="current-catalog-service-hash" content="f3abb0cc802f3d7b95fc8762b94bdcb13bf39634c40c357301c4aa1d67a256fb">


  <meta name="request-id" content="8814:6D33F:D5F9E:104869:697F9C68" data-turbo-transient="true" /><meta name="html-safe-nonce" content="84409d774c6f9f1e6c726a73f1a0f26dd441bd8bc24e683655e5cb3253b46b92" data-turbo-transient="true" /><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHBzOi8vZ2l0aHViLmNvbS9QSU5UTzAzMDkvVUhEIiwicmVxdWVzdF9pZCI6Ijg4MTQ6NkQzM0Y6RDVGOUU6MTA0ODY5OjY5N0Y5QzY4IiwidmlzaXRvcl9pZCI6IjM0ODYxNTAwMjU5MzMxOTc0ODMiLCJyZWdpb25fZWRnZSI6ImNlbnRyYWxpbmRpYSIsInJlZ2lvbl9yZW5kZXIiOiJpYWQifQ==" data-turbo-transient="true" /><meta name="visitor-hmac" content="2e90d0e130199be4dd42e6b6ace57c8920565e9a2330984f3c8bf655643c2280" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="219181390" /><meta name="octolytics-actor-login" content="Muhammad-Faizaan" /><meta name="octolytics-actor-hash" content="e4e1c6ca10bb7a2e38f04dfb8958242782e529ff9ef6abf9f120d1755d1781ae" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detection architectures such as YOLO are overkill. - UHD/compare_wpost_wopost.py at main · PINTO0309/UHD">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/PINTO0309/UHD/blob/main/compare_wpost_wopost.py" />

      <meta name="twitter:image" content="https://repository-images.githubusercontent.com/1104203107/343274bb-e70b-47e5-b1bf-378e4524cdf7" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="UHD/compare_wpost_wopost.py at main · PINTO0309/UHD" /><meta name="twitter:description" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detecti..." />
  <meta property="og:image" content="https://repository-images.githubusercontent.com/1104203107/343274bb-e70b-47e5-b1bf-378e4524cdf7" /><meta property="og:image:alt" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detecti..." /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="UHD/compare_wpost_wopost.py at main · PINTO0309/UHD" /><meta property="og:url" content="https://github.com/PINTO0309/UHD/blob/main/compare_wpost_wopost.py" /><meta property="og:description" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detecti..." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/219181390/ws?session=eyJ2IjoiVjMiLCJ1IjoyMTkxODEzOTAsInMiOjE5NDk3NTg2MTcsImMiOjEwMzEyNzYwMzUsInQiOjE3Njk5NzA3OTN9--4982f52cc63be02a127e020f4ec516bf369e47a6b5cc81d6c6cd17a92773b6c8" data-refresh-url="/_alive" data-session-id="8e478665edf3f192f7b62ad2e45e5990f713551b60600e7c00903f8d113aeb1e">
...
<qbsearch-input class="search-input" data-scope="repo:PINTO0309/UHD" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="VnV7SSLXbh8Gj11xSxgJ9gtC0gPHvaFEN8JZyNeLs8fDFLM8BlyA1AWbKWt656fVHriTeAMRd26lsc7LFLKEGw" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="PINTO0309/UHD" data-current-org="" data-current-owner="PINTO0309" data-logged-in="true" data-copilot-chat-enabled="true" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-83ac2012-4166-4077-b8cd-2d42e8386228" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-83ac2012-4166-4077-b8cd-2d42e8386228" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="WCQvI6fe-umr0IeSyEPVSAb87RY5v1VGcLqaweg9fUrgbjrkA5AJhyeImPoxKD-_z-_Hyrra5_1IYFeq_oHcHg" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="5I-DRxSutjFWzcOoZs31PD3xpxpAR0MrIGyehhSWkBkbmjpYm3ekDhx2X4inE3Ag3bNXo_bIPxP-q-OyEkETkw" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="3Z5cZUejNTNb2BC8C8aAB4fFLxb2fJUaF6tKxWPGAfy73gti2adHbjhorkJcRtmGrK3gII4NmVBw6WAXMNHAvQ" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input>  <input type="hidden" value="MvN4pcLJa2txDmHDhMsdWqS6q1lw0hPQFRUJjuvyox-PBJYlMlne6G97kRdHPb7bsPPId2YjFA2UnXo7LJpkjQ" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
    ...
    <button id="icon-button-c8247e0f-bd49-4259-8e83-aebab7794d4a" aria-labelledby="tooltip-a8fb9b8d-6385-4a01-93f7-c3a4cf99ea3c" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-a8fb9b8d-6385-4a01-93f7-c3a4cf99ea3c" for="icon-button-c8247e0f-bd49-4259-8e83-aebab7794d4a" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MjE5MTgxMzkwIiwidCI6MTc2OTk3MDc5M30=--8c30f940e0f4a70ccec358d05247dec03be1c50ee82df5e616a076338d2129b4" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/PINTO0309/UHD/blob/main/compare_wpost_wopost.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"codeLineWrapEnabled":false,"refInfo":{"name":"main","listCacheKey":"v0:1767509170.0","canEdit":true,"refType":"branch","currentOid":"f4dd3bf4a9b4c4928d6f05f593fde7189c9eb30b","canEditOnDefaultBranch":true,"fileExistsOnDefault":true},"path":"compare_wpost_wopost.py","blob":{"rawLines":["from pathlib import Path","import cv2, numpy as np","from demo_uhd import load_session, preprocess, run_and_decode, postprocess, parse_size","","img_dir = Path(\"partial_images\")","img_size = parse_size(\"64x64\")","models = {","    \"post\": \"ultratinyod_res_anc8_w256_64x64_quality.onnx\",","    \"nopost\": \"ultratinyod_res_anc8_w256_64x64_quality_nopost.onnx\",","}","","sessions, infos = {}, {}","for k, p in models.items():","    sess, info = load_session(p, img_size)","    sessions[k], infos[k] = sess, info","","imgs = [p for p in img_dir.iterdir() if p.suffix.lower() in {\".jpg\",\".jpeg\",\".png\",\".bmp\"}]","stats = {k: {\"boxes\":0,\"images\":0,\"max_w\":0,\"max_h\":0,\"avg_w\":0,\"avg_h\":0} for k in models}","","for img_path in imgs:","    img = cv2.imread(str(img_path), cv2.IMREAD_COLOR)","    if img is None: continue","    h, w = img.shape[:2]","    for name in models:","        dets = run_and_decode(sessions[name], infos[name], preprocess(img, img_size), 0.3)","        boxes = postprocess(dets, (h, w), 0.3)","        if boxes:","            s = stats[name]","            s[\"images\"] += 1; s[\"boxes\"] += len(boxes)","            for _,_,x1,y1,x2,y2 in boxes:","                bw, bh = x2 - x1, y2 - y1","                s[\"max_w\"] = max(s[\"max_w\"], bw); s[\"max_h\"] = max(s[\"max_h\"], bh)","                s[\"avg_w\"] += bw; s[\"avg_h\"] += bh","","for name, s in stats.items():","    count = s[\"boxes\"] or 1","    s[\"avg_w\"] /= count; s[\"avg_h\"] /= count","    print(name, s)"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003epathlib\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003ePath\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003ecv2\u003c/span\u003e, \u003cspan class=pl-s1\u003enumpy\u003c/span\u003e \u003cspan class=pl-k\u003eas\u003c/span\u003e \u003cspan class=pl-s1\u003enp\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003edemo_uhd\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003eload_session\u003c/span\u003e, \u003cspan class=pl-s1\u003epreprocess\u003c/span\u003e, \u003cspan class=pl-s1\u003erun_and_decode\u003c/span\u003e, \u003cspan class=pl-s1\u003epostprocess\u003c/span\u003e, \u003cspan class=pl-s1\u003eparse_size\u003c/span\u003e","","\u003cspan class=pl-s1\u003eimg_dir\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-en\u003ePath\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;partial_images\u0026quot;\u003c/span\u003e)","\u003cspan class=pl-s1\u003eimg_size\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-en\u003eparse_size\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;64x64\u0026quot;\u003c/span\u003e)","\u003cspan class=pl-s1\u003emodels\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e {","    \u003cspan class=pl-s\u003e\u0026quot;post\u0026quot;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026quot;ultratinyod_res_anc8_w256_64x64_quality.onnx\u0026quot;\u003c/span\u003e,","    \u003cspan class=pl-s\u003e\u0026quot;nopost\u0026quot;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026quot;ultratinyod_res_anc8_w256_64x64_quality_nopost.onnx\u0026quot;\u003c/span\u003e,","}","","\u003cspan class=pl-s1\u003esessions\u003c/span\u003e, \u003cspan class=pl-s1\u003einfos\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e {}, {}","\u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003ek\u003c/span\u003e, \u003cspan class=pl-s1\u003ep\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003emodels\u003c/span\u003e.\u003cspan class=pl-c1\u003eitems\u003c/span\u003e():","    \u003cspan class=pl-s1\u003esess\u003c/span\u003e, \u003cspan class=pl-s1\u003einfo\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-en\u003eload_session\u003c/span\u003e(\u003cspan class=pl-s1\u003ep\u003c/span\u003e, \u003cspan class=pl-s1\u003eimg_size\u003c/span\u003e)","    \u003cspan class=pl-s1\u003esessions\u003c/span\u003e[\u003cspan class=pl-s1\u003ek\u003c/span\u003e], \u003cspan class=pl-s1\u003einfos\u003c/span\u003e[\u003cspan class=pl-s1\u003ek\u003c/span\u003e] \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003esess\u003c/span\u003e, \u003cspan class=pl-s1\u003einfo\u003c/span\u003e","","\u003cspan class=pl-s1\u003eimgs\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e [\u003cspan class=pl-s1\u003ep\u003c/span\u003e \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003ep\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003eimg_dir\u003c/span\u003e.\u003cspan class=pl-c1\u003eiterdir\u003c/span\u003e() \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003ep\u003c/span\u003e.\u003cspan class=pl-c1\u003esuffix\u003c/span\u003e.\u003cspan class=pl-c1\u003elower\u003c/span\u003e() \u003cspan class=pl-c1\u003ein\u003c/span\u003e {\u003cspan class=pl-s\u003e\u0026quot;.jpg\u0026quot;\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;.jpeg\u0026quot;\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;.png\u0026quot;\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;.bmp\u0026quot;\u003c/span\u003e}]","\u003cspan class=pl-s1\u003estats\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e {\u003cspan class=pl-s1\u003ek\u003c/span\u003e: {\u003cspan class=pl-s\u003e\u0026quot;boxes\u0026quot;\u003c/span\u003e:\u003cspan class=pl-c1\u003e0\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;images\u0026quot;\u003c/span\u003e:\u003cspan class=pl-c1\u003e0\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;max_w\u0026quot;\u003c/span\u003e:\u003cspan class=pl-c1\u003e0\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;max_h\u0026quot;\u003c/span\u003e:\u003cspan class=pl-c1\u003e0\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;avg_w\u0026quot;\u003c/span\u003e:\u003cspan class=pl-c1\u003e0\u003c/span\u003e,\u003cspan class=pl-s\u003e\u0026quot;avg_h\u0026quot;\u003c/span\u003e:\u003cspan class=pl-c1\u003e0\u003c/span\u003e} \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003ek\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003emodels\u003c/span\u003e}","","\u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003eimg_path\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003eimgs\u003c/span\u003e:","    \u003cspan class=pl-s1\u003eimg\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003ecv2\u003c/span\u003e.\u003cspan class=pl-c1\u003eimread\u003c/span\u003e(\u003cspan class=pl-en\u003estr\u003c/span\u003e(\u003cspan class=pl-s1\u003eimg_path\u003c/span\u003e), \u003cspan class=pl-s1\u003ecv2\u003c/span\u003e.\u003cspan class=pl-c1\u003eIMREAD_COLOR\u003c/span\u003e)","    \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003eimg\u003c/span\u003e \u003cspan class=pl-c1\u003eis\u003c/span\u003e \u003cspan class=pl-c1\u003eNone\u003c/span\u003e: \u003cspan class=pl-k\u003econtinue\u003c/span\u003e","    \u003cspan class=pl-s1\u003eh\u003c/span\u003e, \u003cspan class=pl-s1\u003ew\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003eimg\u003c/span\u003e.\u003cspan class=pl-c1\u003eshape\u003c/span\u003e[:\u003cspan class=pl-c1\u003e2\u003c/span\u003e]","    \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003ename\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003emodels\u003c/span\u003e:","        \u003cspan class=pl-s1\u003edets\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-en\u003erun_and_decode\u003c/span\u003e(\u003cspan class=pl-s1\u003esessions\u003c/span\u003e[\u003cspan class=pl-s1\u003ename\u003c/span\u003e], \u003cspan class=pl-s1\u003einfos\u003c/span\u003e[\u003cspan class=pl-s1\u003ename\u003c/span\u003e], \u003cspan class=pl-en\u003epreprocess\u003c/span\u003e(\u003cspan class=pl-s1\u003eimg\u003c/span\u003e, \u003cspan class=pl-s1\u003eimg_size\u003c/span\u003e), \u003cspan class=pl-c1\u003e0.3\u003c/span\u003e)","        \u003cspan class=pl-s1\u003eboxes\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-en\u003epostprocess\u003c/span\u003e(\u003cspan class=pl-s1\u003edets\u003c/span\u003e, (\u003cspan class=pl-s1\u003eh\u003c/span\u003e, \u003cspan class=pl-s1\u003ew\u003c/span\u003e), \u003cspan class=pl-c1\u003e0.3\u003c/span\u003e)","        \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003eboxes\u003c/span\u003e:","            \u003cspan class=pl-s1\u003es\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003estats\u003c/span\u003e[\u003cspan class=pl-s1\u003ename\u003c/span\u003e]","            \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;images\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e+=\u003c/span\u003e \u003cspan class=pl-c1\u003e1\u003c/span\u003e; \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;boxes\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e+=\u003c/span\u003e \u003cspan class=pl-en\u003elen\u003c/span\u003e(\u003cspan class=pl-s1\u003eboxes\u003c/span\u003e)","            \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003e_\u003c/span\u003e,\u003cspan class=pl-s1\u003e_\u003c/span\u003e,\u003cspan class=pl-s1\u003ex1\u003c/span\u003e,\u003cspan class=pl-s1\u003ey1\u003c/span\u003e,\u003cspan class=pl-s1\u003ex2\u003c/span\u003e,\u003cspan class=pl-s1\u003ey2\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003eboxes\u003c/span\u003e:","                \u003cspan class=pl-s1\u003ebw\u003c/span\u003e, \u003cspan class=pl-s1\u003ebh\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003ex2\u003c/span\u003e \u003cspan class=pl-c1\u003e-\u003c/span\u003e \u003cspan class=pl-s1\u003ex1\u003c/span\u003e, \u003cspan class=pl-s1\u003ey2\u003c/span\u003e \u003cspan class=pl-c1\u003e-\u003c/span\u003e \u003cspan class=pl-s1\u003ey1\u003c/span\u003e","                \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;max_w\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-en\u003emax\u003c/span\u003e(\u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;max_w\u0026quot;\u003c/span\u003e], \u003cspan class=pl-s1\u003ebw\u003c/span\u003e); \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;max_h\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-en\u003emax\u003c/span\u003e(\u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;max_h\u0026quot;\u003c/span\u003e], \u003cspan class=pl-s1\u003ebh\u003c/span\u003e)","                \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;avg_w\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e+=\u003c/span\u003e \u003cspan class=pl-s1\u003ebw\u003c/span\u003e; \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;avg_h\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e+=\u003c/span\u003e \u003cspan class=pl-s1\u003ebh\u003c/span\u003e","","\u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003ename\u003c/span\u003e, \u003cspan class=pl-s1\u003es\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003estats\u003c/span\u003e.\u003cspan class=pl-c1\u003eitems\u003c/span\u003e():","    \u003cspan class=pl-s1\u003ecount\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;boxes\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003eor\u003c/span\u003e \u003cspan class=pl-c1\u003e1\u003c/span\u003e","    \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;avg_w\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e/=\u003c/span\u003e \u003cspan class=pl-s1\u003ecount\u003c/span\u003e; \u003cspan class=pl-s1\u003es\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;avg_h\u0026quot;\u003c/span\u003e] \u003cspan class=pl-c1\u003e/=\u003c/span\u003e \u003cspan class=pl-s1\u003ecount\u003c/span\u003e","    \u003cspan class=pl-en\u003eprint\u003c/span\u003e(\u003cspan class=pl-s1\u003ename\u003c/span\u003e, \u003cspan class=pl-s1\u003es\u003c/span\u003e)"],"csv":null,"csvError":null,"copilotSWEAgentEnabled":false,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/PINTO0309/UHD/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"compare_wpost_wopost.py","displayUrl":"https://github.com/PINTO0309/UHD/blob/main/compare_wpost_wopost.py?raw=true","headerInfo":{"blobSize":"1.37 KB","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"x-github-client://openRepo/https://github.com/PINTO0309/UHD?branch=main\u0026filepath=compare_wpost_wopost.py","isGitLfs":false,"onBranch":true,"shortPath":"3a8ab43","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2FPINTO0309%2FUHD%2Fblob%2Fmain%2Fcompare_wpost_wopost.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"38","truncatedSloc":"33"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/PINTO0309/UHD/blob/main/compare_wpost_wopost.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/PINTO0309/UHD/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/PINTO0309/UHD/raw/refs/heads/main/compare_wpost_wopost.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":4,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"img_dir","kind":"constant","ident_start":137,"ident_end":144,"extent_start":137,"extent_end":169,"fully_qualified_name":"img_dir","ident_utf16":{"start":{"line_number":4,"utf16_col":0},"end":{"line_number":4,"utf16_col":7}},"extent_utf16":{"start":{"line_number":4,"utf16_col":0},"end":{"line_number":4,"utf16_col":32}}},{"name":"img_size","kind":"constant","ident_start":170,"ident_end":178,"extent_start":170,"extent_end":200,"fully_qualified_name":"img_size","ident_utf16":{"start":{"line_number":5,"utf16_col":0},"end":{"line_number":5,"utf16_col":8}},"extent_utf16":{"start":{"line_number":5,"utf16_col":0},"end":{"line_number":5,"utf16_col":30}}},{"name":"models","kind":"constant","ident_start":201,"ident_end":207,"extent_start":201,"extent_end":342,"fully_qualified_name":"models","ident_utf16":{"start":{"line_number":6,"utf16_col":0},"end":{"line_number":6,"utf16_col":6}},"extent_utf16":{"start":{"line_number":6,"utf16_col":0},"end":{"line_number":9,"utf16_col":1}}},{"name":"imgs","kind":"constant","ident_start":480,"ident_end":484,"extent_start":480,"extent_end":571,"fully_qualified_name":"imgs","ident_utf16":{"start":{"line_number":16,"utf16_col":0},"end":{"line_number":16,"utf16_col":4}},"extent_utf16":{"start":{"line_number":16,"utf16_col":0},"end":{"line_number":16,"utf16_col":91}}},{"name":"stats","kind":"constant","ident_start":572,"ident_end":577,"extent_start":572,"extent_end":663,"fully_qualified_name":"stats","ident_utf16":{"start":{"line_number":17,"utf16_col":0},"end":{"line_number":17,"utf16_col":5}},"extent_utf16":{"start":{"line_number":17,"utf16_col":0},"end":{"line_number":17,"utf16_col":91}}}]}},"copilotInfo":null,"copilotAccessAllowed":true,"copilotSpacesEnabled":true,"modelsAccessAllowed":false,"modelsRepoIntegrationEnabled":false,"isMarketplaceEnabled":true,"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":"ckpts","path":"ckpts","contentType":"directory"},{"name":"uhd","path":"uhd","contentType":"directory"},{"name":".gitignore","path":".gitignore","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"compare_torchvision_cv2_resize.py","path":"compare_torchvision_cv2_resize.py","contentType":"file"},{"name":"compare_wpost_wopost.py","path":"compare_wpost_wopost.py","contentType":"file"},{"name":"demo_uhd.py","path":"demo_uhd.py","contentType":"file"},{"name":"demo_uhd_lite.py","path":"demo_uhd_lite.py","contentType":"file"},{"name":"export_cpp.py","path":"export_cpp.py","contentType":"file"},{"name":"export_onnx.py","path":"export_onnx.py","contentType":"file"},{"name":"profile_onnx.py","path":"profile_onnx.py","contentType":"file"},{"name":"pyproject.toml","path":"pyproject.toml","contentType":"file"},{"name":"train.py","path":"train.py","contentType":"file"},{"name":"uhd_export_bin.h","path":"uhd_export_bin.h","contentType":"file"},{"name":"uv.lock","path":"uv.lock","contentType":"file"}],"totalCount":16}},"fileTreeProcessingTime":8.270151,"incompleteFileTree":false,"foldersToFetch":[],"repo":{"id":1104203107,"defaultBranch":"main","name":"UHD","ownerLogin":"PINTO0309","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2025-11-26T03:34:25.000+05:00","ownerAvatar":"https://avatars.githubusercontent.com/u/33194443?v=4","public":true,"private":false,"isOrgOwned":false},"currentUser":{"id":219181390,"login":"Muhammad-Faizaan","userEmail":"mohammadfaizan0997@gmail.com"},"csrf_tokens":{"/PINTO0309/UHD/branches":{"post":"e4Q1DM2VD9DUUr5w0nTT2GKQ1Kh8blXwykkKTRt7yyEpBXyHfnLG8YdJaR46eCeuJMxbaVcrxr6r4jw1NGXGew"}}},"title":"UHD/compare_wpost_wopost.py at main · PINTO0309/UHD","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-5acd58e615f7.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-c073d0e0b342.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"react_blob_overlay":true,"accessible_code_button":true}}}</script>
...
<div id="LC12" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-s1>sessions</span>, <span class=pl-s1>infos</span> <span class=pl-c1>=</span> {}, {}</div>
<div id="LC13" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>for</span> <span class=pl-s1>k</span>, <span class=pl-s1>p</span> <span class=pl-c1>in</span> <span class=pl-s1>models</span>.<span class=pl-c1>items</span>():</div>
<div id="LC14" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>sess</span>, <span class=pl-s1>info</span> <span class=pl-c1>=</span> <span class=pl-en>load_session</span>(<span class=pl-s1>p</span>, <span class=pl-s1>img_size</span>)</div>
<div id="LC15" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>sessions</span>[<span class=pl-s1>k</span>], <span class=pl-s1>infos</span>[<span class=pl-s1>k</span>] <span class=pl-c1>=</span> <span class=pl-s1>sess</span>, <span class=pl-s1>info</span></div>
<div id="LC16" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC17" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-s1>imgs</span> <span class=pl-c1>=</span> [<span class=pl-s1>p</span> <span class=pl-k>for</span> <span class=pl-s1>p</span> <span class=pl-c1>in</span> <span class=pl-s1>img_dir</span>.<span class=pl-c1>iterdir</span>() <span class=pl-k>if</span> <span class=pl-s1>p</span>.<span class=pl-c1>suffix</span>.<span class=pl-c1>lower</span>() <span class=pl-c1>in</span> {<span class=pl-s>&quot;.jpg&quot;</span>,<span class=pl-s>&quot;.jpeg&quot;</span>,<span class=pl-s>&quot;.png&quot;</span>,<span class=pl-s>&quot;.bmp&quot;</span>}]</div>
<div id="LC18" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-s1>stats</span> <span class=pl-c1>=</span> {<span class=pl-s1>k</span>: {<span class=pl-s>&quot;boxes&quot;</span>:<span class=pl-c1>0</span>,<span class=pl-s>&quot;images&quot;</span>:<span class=pl-c1>0</span>,<span class=pl-s>&quot;max_w&quot;</span>:<span class=pl-c1>0</span>,<span class=pl-s>&quot;max_h&quot;</span>:<span class=pl-c1>0</span>,<span class=pl-s>&quot;avg_w&quot;</span>:<span class=pl-c1>0</span>,<span class=pl-s>&quot;avg_h&quot;</span>:<span class=pl-c1>0</span>} <span class=pl-k>for</span> <span class=pl-s1>k</span> <span class=pl-c1>in</span> <span class=pl-s1>models</span>}</div>
<div id="LC19" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC20" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>for</span> <span class=pl-s1>img_path</span> <span class=pl-c1>in</span> <span class=pl-s1>imgs</span>:</div>
<div id="LC21" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>img</span> <span class=pl-c1>=</span> <span class=pl-s1>cv2</span>.<span class=pl-c1>imread</span>(<span class=pl-en>str</span>(<span class=pl-s1>img_path</span>), <span class=pl-s1>cv2</span>.<span class=pl-c1>IMREAD_COLOR</span>)</div>
<div id="LC22" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>if</span> <span class=pl-s1>img</span> <span class=pl-c1>is</span> <span class=pl-c1>None</span>: <span class=pl-k>continue</span></div>
<div id="LC23" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>h</span>, <span class=pl-s1>w</span> <span class=pl-c1>=</span> <span class=pl-s1>img</span>.<span class=pl-c1>shape</span>[:<span class=pl-c1>2</span>]</div>
<div id="LC24" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>for</span> <span class=pl-s1>name</span> <span class=pl-c1>in</span> <span class=pl-s1>models</span>:</div>
<div id="LC25" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-s1>dets</span> <span class=pl-c1>=</span> <span class=pl-en>run_and_decode</span>(<span class=pl-s1>sessions</span>[<span class=pl-s1>name</span>], <span class=pl-s1>infos</span>[<span class=pl-s1>name</span>], <span class=pl-en>preprocess</span>(<span class=pl-s1>img</span>, <span class=pl-s1>img_size</span>), <span class=pl-c1>0.3</span>)</div>
<div id="LC26" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-s1>boxes</span> <span class=pl-c1>=</span> <span class=pl-en>postprocess</span>(<span class=pl-s1>dets</span>, (<span class=pl-s1>h</span>, <span class=pl-s1>w</span>), <span class=pl-c1>0.3</span>)</div>
<div id="LC27" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-k>if</span> <span class=pl-s1>boxes</span>:</div>
<div id="LC28" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">            <span class=pl-s1>s</span> <span class=pl-c1>=</span> <span class=pl-s1>stats</span>[<span class=pl-s1>name</span>]</div>
<div id="LC29" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">            <span class=pl-s1>s</span>[<span class=pl-s>&quot;images&quot;</span>] <span class=pl-c1>+=</span> <span class=pl-c1>1</span>; <span class=pl-s1>s</span>[<span class=pl-s>&quot;boxes&quot;</span>] <span class=pl-c1>+=</span> <span class=pl-en>len</span>(<span class=pl-s1>boxes</span>)</div>
<div id="LC30" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">            <span class=pl-k>for</span> <span class=pl-s1>_</span>,<span class=pl-s1>_</span>,<span class=pl-s1>x1</span>,<span class=pl-s1>y1</span>,<span class=pl-s1>x2</span>,<span class=pl-s1>y2</span> <span class=pl-c1>in</span> <span class=pl-s1>boxes</span>:</div>
<div id="LC31" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                <span class=pl-s1>bw</span>, <span class=pl-s1>bh</span> <span class=pl-c1>=</span> <span class=pl-s1>x2</span> <span class=pl-c1>-</span> <span class=pl-s1>x1</span>, <span class=pl-s1>y2</span> <span class=pl-c1>-</span> <span class=pl-s1>y1</span></div>
<div id="LC32" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                <span class=pl-s1>s</span>[<span class=pl-s>&quot;max_w&quot;</span>] <span class=pl-c1>=</span> <span class=pl-en>max</span>(<span class=pl-s1>s</span>[<span class=pl-s>&quot;max_w&quot;</span>], <span class=pl-s1>bw</span>); <span class=pl-s1>s</span>[<span class=pl-s>&quot;max_h&quot;</span>] <span class=pl-c1>=</span> <span class=pl-en>max</span>(<span class=pl-s1>s</span>[<span class=pl-s>&quot;max_h&quot;</span>], <span class=pl-s1>bh</span>)</div>
<div id="LC33" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                <span class=pl-s1>s</span>[<span class=pl-s>&quot;avg_w&quot;</span>] <span class=pl-c1>+=</span> <span class=pl-s1>bw</span>; <span class=pl-s1>s</span>[<span class=pl-s>&quot;avg_h&quot;</span>] <span class=pl-c1>+=</span> <span class=pl-s1>bh</span></div>
<div id="LC34" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC35" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>for</span> <span class=pl-s1>name</span>, <span class=pl-s1>s</span> <span class=pl-c1>in</span> <span class=pl-s1>stats</span>.<span class=pl-c1>items</span>():</div>
<div id="LC36" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>count</span> <span class=pl-c1>=</span> <span class=pl-s1>s</span>[<span class=pl-s>&quot;boxes&quot;</span>] <span class=pl-c1>or</span> <span class=pl-c1>1</span></div>
<div id="LC37" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>s</span>[<span class=pl-s>&quot;avg_w&quot;</span>] <span class=pl-c1>/=</span> <span class=pl-s1>count</span>; <span class=pl-s1>s</span>[<span class=pl-s>&quot;avg_h&quot;</span>] <span class=pl-c1>/=</span> <span class=pl-s1>count</span></div>
<div id="LC38" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-en>print</span>(<span class=pl-s1>name</span>, <span class=pl-s1>s</span>)</div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-62in7e-0 vdPNv"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA__R_0___">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
